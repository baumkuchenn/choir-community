    ...
    public function run(): void
    {
        DB::table('events')->insert([
            [
                ...
                'tanggal_selesai' => Carbon::parse('2026-02-15'),
            ...
            [
                ...
                'tanggal_selesai' => Carbon::parse('2026-02-16'),
                'jam_mulai'       => Carbon::parse('17:00:00')->format('H:i:s'),
                'jam_selesai'     => Carbon::parse('21:00:00')->format('H:i:s'),
            ...
            [
                ...
                'tanggal_selesai' => Carbon::parse('2026-02-22'),
                'jam_mulai'       => Carbon::parse('17:00:00')->format('H:i:s'),
                'jam_selesai'     => Carbon::parse('21:00:00')->format('H:i:s'),
            ...
            [
                ...
                'tanggal_selesai' => Carbon::parse('2026-02-23'),
                'jam_mulai'       => Carbon::parse('17:00:00')->format('H:i:s'),
                'jam_selesai'     => Carbon::parse('21:00:00')->format('H:i:s'),
            ...
            [
                ...
                'tanggal_selesai' => Carbon::parse('2026-03-01'),
                'jam_mulai'       => Carbon::parse('17:00:00')->format('H:i:s'),
                'jam_selesai'     => Carbon::parse('21:00:00')->format('H:i:s'),
                'lokasi'          => 'Auditorium Universitas Kristen Petra, Surabaya',
                'peran'           => 'Keduanya',
