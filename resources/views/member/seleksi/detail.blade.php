        ...
        <form method="POST" action="{{ route('seleksi.simpan-pendaftar') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="form-control" id="jenis_kelamin" name="jenis_kelamin">{{ $pendaftar->user->jenis_kelamin_label }}</div>
                </div>
                <div class="col-6">
            ...
            <div class="row">
                @if ($pendaftar->lolos == 'belum')
                    @if ($seleksi->tipe === 'panitia')
                        @if (!empty($pendaftar->hasil_wawancara))
                        ...
                        @endif
                    @elseif ($seleksi->tipe === 'event' || $seleksi->tipe === 'member')
